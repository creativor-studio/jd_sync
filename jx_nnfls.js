    ...
    return __generator(this, function (_o) {
        switch (_o.label) {
            ...
            case 9:
                ...
                _o.label = 10;
            case 10:
                _o.trys.push([10, 18, 19, 20]);
                _e = (e_1 = void 0, __values(res.data.tasks)), _f = _e.next();
                _o.label = 11;
            case 11:
                if (!!_f.done) return [3 /*break*/, 17];
                t = _f.value;
                if (!(tasks.includes(t.taskId) && t.taskState === 1)) return [3 /*break*/, 16];
            ...
            case 23:
                res = _o.sent();
                console.log('抽奖成功', ((_m = (_l = res.data) === null || _l === void 0 ? void 0 : _l.prize[0]) === null || _m === void 0 ? void 0 : _m.prizename) || JSON.stringify(res));
                coin -= 10;
